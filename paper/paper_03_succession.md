...
A complementary Gaussian Mixture Model analysis (GMM, k = 5 by BIC) applied to all 401 systems on the full six-dimensional governance space identifies two structurally distinct archetypes in the high-D/low-S region that the two-dimensional phase space cannot distinguish. Both achieve high D and low S, but through different mechanisms:
