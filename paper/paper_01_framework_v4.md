...
**Figure 2. EDR vs. SAP Scatter.** EDR composite (y-axis) plotted against SAP composite (x-axis) for 401 systems, coloured by collapse mode. Dashed line: linear trend for hand-coded subset (r = −0.844). Shaded region: fragile regime (EDR < θ = 0.45). Large dots: hand-coded; small dots: auto-coded.
